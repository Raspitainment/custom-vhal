...
class DefaultVehicleHal : public VehicleHal {
  ...
  protected:
    ...
    StatusCode checkValueRange(const VehiclePropValue &propValue, const VehicleAreaConfig *areaConfig);
    ...
    VehiclePropValuePtr getUserHalProp(const VehiclePropValue &requestedPropValue, StatusCode *outStatus);
  ...
  private:
    ...
    StatusCode checkVendorMixedPropValue(const VehiclePropValue &value, const VehiclePropConfig *config);
    ...
    // Returns a lambda that could be used in mRecurrentTimer.
    RecurrentTimer::Action getGPIOTimerAction();
    // The callback that would be called for every event generated by 'subscribe' or heartbeat.
    // Properties contains a list of properties that need to be handled.
    void onGPIOPropertyTimer();
};
